...
:items="items">
<template #top>
<div class="top-div"><p class="display-1 white--text">Meeting and workshops
<span>
<v-tooltip bottom>
...
<template #item.Meeting_and_workshops="{item}">
  <td v-if="editable && editindex==items.indexOf(item)">
     <v-text-field class="tx1" v-model="Meeting_and_workshops"></v-text-field>
  </td>
  <td id="td1" v-else>{{item.Meeting_and_workshops}}</td>
</template>
...
export default{
	...
	Units:'',
	year1_Units:'',
	Meeting_and_workshops:'',
	Detailed_Explanation:'',
	Totalsum:0,
	year1sum:0,


	headers:[{text:'',value:'Meeting_and_workshops',sortable:false},
...
add(){
  ...
  this.editable=true
  this.items.push({Meeting_and_workshops:'', Units:'',Total_No_of_Units:'',Total_Unit_value:'',Total_Total_cost:''
...
save(e,item,totalcost,year1cost){
  ...
  this.items[index].Meeting_and_workshops=this.Meeting_and_workshops

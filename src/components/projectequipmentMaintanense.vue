...
<template #item.Project_equipment_maintanense="{item}">
  <td v-if="editable && editindex==items.indexOf(item)">
     <v-text-field class="tx1" v-model="Project_equipment_maintanense"></v-text-field>
  </td>
  <td id="td1" v-else>{{item.Project_equipment_maintanense}}</td>
</template>
...
export default{
	...
	Units:'',
	year1_Units:'',
	Project_equipment_maintanense:'',
	Detailed_Explanation:'',
	Totalsum:0,
	year1sum:0,


	headers:[{text:'',value:'Project_equipment_maintanense',sortable:false},
...
add(){
  ...
  this.editable=true
  this.items.push({Project_equipment_maintanense:'', Units:'',Total_No_of_Units:'',Total_Unit_value:'',Total_Total_cost:''
...
deleteitem(item){
   ...
   this.$emit('projectequipment',{subtotal:this.Totalsum,year1sum:this.year1sum})
},
save(e,item,totalcost,year1cost){
  ...
  this.items[index].Project_equipment_maintanense=this.Project_equipment_maintanense
